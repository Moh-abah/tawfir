...
const FAQ_ITEMS = [
  {
    q: "ما هي منصة توفير؟",
    a: `منصة توفير تتيح لك طلب وجباتك من المطاعم والكافتيريات المشتركة، مع إمكانية الاشتراك في عضوية سنوية تمنحك خصم ${DISCOUNT_RATE}% على كل طلباتك.`,
  },
  {
  ...
  {
    q: `كم نسبة الخصم؟`,
    a: `خصم ${DISCOUNT_RATE}% على كل طلباتك من المطاعم والكافتيريات المشتركة طوال فترة عضويتك السنوية. يُطبّق الخصم تلقائياً عند الطلب إن كانت عضويتك مفعّلة.`,
  },
  {
