  ...
  const sections: ReadonlyArray<Section> = [
    {
      ...
      points: [
        ...
        "رقم العضوية وتاريخ انتهائها — لإدارة استحقاقك للخصومات لدى المتاجر المشتركة (بعد موافقتك على الاشتراك).",
      ],
    },
    {
      icon: ShieldCheck,
      ...
      points: [
        ...
        "تشغيل الخدمة الأساسية: عرض المتاجر والمنتجات والعروض المشتركة.",
      ],
    },
    {
      icon: Truck,
      ...
      points: [
        "عنوان التوصيل ومعلومات الموقع تُستخدَم حصراً لأغراض تجهيز وتوصيل طلباتك من المطاعم والكافتيريات.",
