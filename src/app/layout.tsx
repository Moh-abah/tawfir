...
export const metadata: Metadata = {
  ...
  description:
    "منصة توفير اليمنية — تصفّح الوجبات اليمنية من المطاعم والكافتيريات واطلبها، واشترك في عضوية الخصم حتى 30%. اختر منطقتك واستمتع بالعروض الحصرية.",
  keywords: ["توفير", "Tawfir", "طلب وجبات", "وجبات يمنية", "مندي", "خصم حتى 30%", "مطاعم", "كافتيريات", "اليمن", "عضوية"],
  authors: [{ name: "توفير" }],
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "منصة يمنية للخصومات على الوجبات — خصم حتى 30% للأعضاء في المطاعم والكافتيريات المشتركة",
              inLanguage: "ar",
              publisher: {
                "@type": "Organization",
                name: "توفير",
