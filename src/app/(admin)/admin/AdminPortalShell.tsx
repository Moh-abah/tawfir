...
/*
 * AdminPortalShell — واجهة لوحة الإدارة (مكوّن عميل).
 * فُصل عن layout.tsx (الذي أصبح Server Component يصدّر ميتا
 * بوابة الأدمن المستقلة — إصلاح هوية بوابة الأدمن: كانت ترث
 * ميتا تطبيق العميل بالكامل).
 */
    ...
    <AdminAuthGuard>
      <div className="flex min-h-screen flex-col">
        {/* Mobile top bar — ✦ 4-a: رمز الشعار المقصوص بجانب العنوان
            pt-safe: حشوة شريط الحالة داخل APK (Edge-to-Edge) — على الويب 0 */}
        <header className="pt-safe sticky top-0 z-40 flex h-14 items-center justify-between gap-2 border-b bg-card px-3 lg:hidden">
          <Button
            variant="ghost"
            size="icon"
